...
# WHERE: tooloo_v3_hub/tests/test_sota_verification.py
...
from tooloo_v3_hub.kernel.cognitive.value_evaluator import get_value_evaluator
...
async def run_final_value_eval():
    ...
    report = StampingEngine.audit_hub("tooloo_v3_hub")
