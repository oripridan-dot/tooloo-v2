...
# WHERE: tooloo_v3_hub/tools/sovereign_launcher.py
...
async def launch_hub_api():
    ...
    from tooloo_v3_hub.kernel.hub_api import app
    import uvicorn
...
async def tether_organs():
    ...
    await nexus.register_organ("sovereign_chat", "subprocess", {
        "command": [python_exec, "-m", "tooloo_v3_hub.organs.sovereign_chat.mcp_server"]
    })
