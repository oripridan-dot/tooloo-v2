...
# WHERE: tooloo_v3_hub/tools/tree_builder.py
...
def run_tree_builder(root_dir: str = "tooloo_v3_hub"):
    ...
    import_pattern = re.compile(r"from (tooloo_v3_hub\.[a-zA-Z0-9_\.]+) import|import (tooloo_v3_hub\.[a-zA-Z0-9_\.]+)")
