...
class RecursiveSummaryAgent:
    ...
    def distill_pending(self) -> dict[str, Any]:
        ...
        try:
            # ModelGarden.call() returns a plain string response
            text = self.garden.call(model_id, prompt).strip()
            ...
            return {"status": "error", "processed": 0, "facts_extracted": 0, "error": str(e)}
